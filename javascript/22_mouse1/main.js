...
class sample0 extends sampleBase{
  ...
  initialize(){
    this.obj[5] = new window2(5,[100,600,800,100]);
    this.obj[0] = new window0(1,[100,100,200,100]);
    this.obj[1] = new window0(2,[100,300,200,100]);
    this.obj[2] = new window1(3,[150,150,200,100]);
    this.obj[3] = new window0(4,[150,350,200,100]);
    this.obj[4] = new sample1(10,[500,100,400,400]);
    for(let i=0;i<5;i++){
      this.obj[i].setonhover(this.obj[5]);
    }
  }
}
...
class sample1 extends sampleBase{
  ...
  initialize(){
    ...
    this.obj[0] = new window0(11,[x0+100,y0+50,200,100]);
    this.obj[1] = new window0(12,[x0+100,y0+250,200,100]);
  }
  setonhover(xx){
    for(let i=0;i<2;i++){
...
class window0{
  ...
  hoverfunc(xx,yy){
    ...
    if(this.hover && this.notify){this.notify.settext(this.id);}
    return 0;
  }
  clickfunc(xx,yy){
